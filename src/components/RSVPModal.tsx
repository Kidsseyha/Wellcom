      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-md bg-black border border-amber-500/40 rounded-2xl p-6 sm:p-7 shadow-2xl text-left my-8"
          >
            {/* Close */}
            <button
              onClick={onClose}
            ...
            {submitted ? (
              <div className="text-center py-6">
                ...
                <h3 className="text-lg font-moul text-amber-200 mb-2">
                  {language === 'kh' ? 'សូមអរគុណ!' : 'Thank You!'}
                </h3>
                <p className="text-sm text-neutral-300 font-khmer mb-6 leading-relaxed">
                  {attending === 'yes'
                    ? language === 'kh'
                ...
                <button
                  onClick={onClose}
                  className="py-2.5 px-6 rounded-xl font-moul text-xs text-amber-950 font-bold bg-amber-400 hover:bg-amber-300 transition-all"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {/* Guest Name */}
                <div>
                  <label className="block text-xs font-semibold text-amber-200/90 font-khmer mb-1 flex items-center gap-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl bg-black/60 border border-amber-500/30 text-amber-100 placeholder-neutral-500 text-sm font-khmer focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400"
                  />
                </div>

                {/* Attendance Radio */}
                <div>
                  <label className="block text-xs font-semibold text-amber-200/90 font-khmer mb-1.5">
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    <button
                      ...
                      className={`py-2.5 px-3 rounded-xl text-xs font-khmer font-semibold border text-center transition-all ${
                        attending === 'yes'
                          ? 'bg-amber-400 text-amber-950 border-amber-300 font-bold shadow-md'
                    ...
                    <button
                      ...
                      className={`py-2.5 px-3 rounded-xl text-xs font-khmer font-semibold border text-center transition-all ${
                        attending === 'no'
                          ? 'bg-rose-950 text-rose-200 border-rose-500 font-bold shadow-md'
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3.5 py-2.5 rounded-xl bg-black/60 border border-amber-500/30 text-amber-100 text-sm font-khmer focus:outline-none focus:border-amber-400"
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2.5 rounded-xl bg-black/60 border border-amber-500/30 text-amber-100 placeholder-neutral-500 text-sm focus:outline-none focus:border-amber-400"
                      />
                    </div>
                  </>
                )}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3.5 py-2 rounded-xl bg-black/60 border border-amber-500/30 text-amber-100 placeholder-neutral-500 text-xs font-khmer focus:outline-none focus:border-amber-400"
                  />
                </div>
                ...
                <button
                  id="submit-rsvp-btn"
                  type="submit"
                  className="w-full py-3 px-5 rounded-xl font-moul text-xs sm:text-sm text-amber-950 font-bold bg-gradient-to-r from-amber-300 via-amber-400 to-amber-300 hover:from-amber-200 hover:to-amber-400 border border-amber-200 shadow-lg shadow-amber-950/50 transition-all hover:scale-[1.01]"
                >
