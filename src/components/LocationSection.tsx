    ...
    <section id="location-section" className="py-8 px-4 text-center">
      ...
      >
        ...
        <p
          ...
          className="text-sm font-khmer leading-relaxed px-2 mb-6 opacity-90"
        >
          {displayLocation}
        </p>

        {/* Venue Image / Map Preview with interactive frame */}
        <div className="relative rounded-2xl overflow-hidden border-2 border-amber-500/40 shadow-xl shadow-black/40 group mb-6 bg-black/40">
          <img
            src={mapImageUrl}
            alt="Venue Map"
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <motion.a
            ...
            whileTap={{ scale: 0.96 }}
            className="w-full sm:flex-1 py-3 px-5 rounded-xl font-moul text-xs sm:text-sm text-amber-950 font-bold bg-gradient-to-r from-amber-300 via-amber-400 to-amber-300 border border-amber-200 shadow-lg shadow-amber-950/40 flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="w-full sm:w-auto py-3 px-4 rounded-xl text-xs font-semibold font-khmer bg-amber-950/40 hover:bg-amber-900/40 text-amber-200 border border-amber-500/30 flex items-center justify-center gap-2 transition-all"
          >
            {copied ? (
              <>
